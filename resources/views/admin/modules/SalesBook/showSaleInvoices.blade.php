          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$saleInvoice->zone}}</td>
                <td>{{$saleInvoice->gatePass}}</td>
                ...
                <td>
                  <button class="btn btn-danger">
                    <a style="color: white;" href="delete_dispatch?startDate={{$saleInvoice->startDate}}&endDate={{$saleInvoice->endDate}}&partyName={{$saleInvoice->partyName}}&invoice={{$saleInvoice->invoice}}">Delete</a>
                  </button>
                </td>
              </tr>
              @endforeach
