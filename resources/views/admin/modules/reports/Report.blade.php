                                ...
                                <div class="card-body">
                                    <div id="cardStart" style="padding:20px" class="card card-outline card-info">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="vender_name" id="vender_name" required class="form-control select2 select2bs4">
                                                        <option disabled selected value="">Choose value...</option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div style="margin-right: 30px;" class="col-md-2">
                                                <input onclick="getPartyReport()" class="btn btn-primary" value="purchase" type="button">
                                            </div>
