                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <select name="itemname" onchange="getVarientOfSelectedItem(this.value)" id="itemname" required class="form-control">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <select name="varient" id="varient" required class="form-control">
